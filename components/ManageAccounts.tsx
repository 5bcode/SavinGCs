    ...
    return (
        <div className="pot-item" onClick={onClick}>
            ...
            <div className="flex items-center gap-sm">
                ...
                <button onClick={(e) => { e.stopPropagation(); onDelete(); }} className="icon-btn" aria-label={`Delete ${account.account_name} account`} style={{ color: 'var(--error)', width: '32px', height: '32px' }}>
