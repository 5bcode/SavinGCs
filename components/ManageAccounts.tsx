    ...
    return (
        <div className="pot-item" onClick={onClick}>
            ...
            <div className="flex items-center gap-sm">
                ...
                <button aria-label={`Delete account ${account.account_name}`} title={`Delete account ${account.account_name}`} onClick={(e) => { e.stopPropagation(); onDelete(); }} className="icon-btn" style={{ color: 'var(--error)', width: '32px', height: '32px' }}>
