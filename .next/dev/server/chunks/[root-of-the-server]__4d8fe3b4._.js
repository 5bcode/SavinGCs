...
"[project]/Desktop/SavinGCs/app/api/pots/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const pots = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$SavinGCs$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
      SELECT 
        sp.*,
...
async function POST(request) {
    try {
      ...
      INSERT INTO savings_pots (name, goal_amount, color, icon, priority)
      VALUES (?, ?, ?, ?, ?)
    `).run(name, goalAmount || null, color || '#059669', icon || 'piggy-bank', priority || 0);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$SavinGCs$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d8fe3b4._.js.map