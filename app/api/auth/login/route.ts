...
// Pre-calculate a dummy hash to use when the user is not found, preventing timing attacks.
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        // Always perform the bcrypt comparison to prevent username enumeration via timing attacks
