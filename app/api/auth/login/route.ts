...
// Pre-calculated hash to ensure constant-time verification even if user doesn't exist
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        // Always perform comparison to prevent username enumeration via timing attacks
